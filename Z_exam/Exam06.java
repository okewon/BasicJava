...
//		a. 메서드의 이름이 같아야 한다.		c,d
//		b. 매개변수의 개수나 타입이 달라야 한다.
//		c. 리턴타입이 달라야 한다.
//		d. 매개변수의 이름이 달라야 한다.
		
//		[6-13] 다음 중 아래의 add메서드를 올바르게 오버로딩 한 것은? (모두 고르시오)
//		long add(int a, int b) { return a+b;}		b,c,d
...
//		a.멤버변수는 자동 초기화되므로 초기화하지 않고도 값을 참조할 수 있다.	c,d,e
...
//		a. 자동 초기화되므로 별도의 초기화가 필요없다.			a,e
//		b. 지역변수가 선언된 메서드가 종료되면 지역변수도 함께 소멸된다.
//		c. 매서드의 매개변수로 선언된 변수도 지역변수이다.
//		d. 클래스변수나 인스턴스변수보다 메모리 부담이 적다.
//		e. 힙(heap)영역에 생성되며 가비지 컬렉터에 의해 소멸된다.
		/*
		 * 지역변수는 자동 초기화되지 않기 때문에 사용하기 전에 반드시 초기화해주어야 한다.
		 * 힙 영역에는 인스턴스가 생성되는 영역으로, 지역변수는 호출 스택에 생성된다.
		 */
...
//		[연습문제]/ch6/Exercise6_19.java 		ABC123
//			class Exercise6_19{
