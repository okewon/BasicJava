...
public class SampleClass {
	...
	/*
	 *  - 메소드 : 코드를 분리해서 더 효율적인 프로그램 만들기 위한 도구
	 *  - 리턴타입 메소드명(파라미터){}
	...
	void flowTest1(){
		System.out.println("flowTest1 시작 : 1"); //1번
		flowTest3();
		System.out.println("flowTest1 종료 : 6"); //6번
	}
	
	void flowTest2(){
		System.out.println("flowTest2 시작 : 3"); //3번
		System.out.println("flowTest2 종료 : 4"); //4번
	}
	
	void flowTest3(){
		System.out.println("flowTest3 시작 : 2"); //2번
		flowTest2();
		System.out.println("flowTest3 종료 : 5"); //5번
	}
